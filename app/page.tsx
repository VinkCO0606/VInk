    ...
    <div className="min-h-screen bg-gray-50 font-sans text-emerald-950 selection:bg-purple-200">
      ...
      <section className="bg-emerald-50 py-12 border-t border-emerald-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="flex flex-col items-center justify-center gap-4 text-emerald-700 mb-4">
            <AlertCircle size={32} className="animate-wiggle" />
            <h4 className="font-bold text-emerald-800 uppercase tracking-widest text-sm">Aviso Importante</h4>
          </div>
